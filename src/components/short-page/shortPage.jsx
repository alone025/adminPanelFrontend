...
const ShortPage = () => {
  return (
  <div className="lkmljnn flex flex-col lg:flex-row justify-around gap-[50px] lg:gap-[70px] xl:gap-[79px]">
    ...
    <div className="rhis relative -z-[1] max-w-max lg:max-w-[560px] xl:max-w-[600px]">
        ...
        <p className="text-[13px] sm:text-[14px] md:text-[15px] xl:text-[16px] font-light font-azosansLight text-[#fff] opacity-60 mb-[15px]" >There are several thousand celebrities and creators on twitter, tiktok, Instagram and YouTube with followings in the millions who we would be <span className="font-medium">actively engaging</span> before we go viral. </p>
        <p className="text-[13px] sm:text-[14px] md:text-[15px] xl:text-[16px] font-light font-azosansLight text-[#fff] opacity-60" >We would get them on our
