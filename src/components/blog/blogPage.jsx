function BlogPage() {
  return (
    <div className="bg-[#1D1534] w-full">
      <div className="pt-[200px] px-8 sm:px-10 md:px-12 py-[16px]">
        ...
        <div className="relative mx-[50px] bg-[#032457] max-w-[1491px] h-[467px] rounded-[30px] mt-[61px] z-10">
          <div className="flex justify-center items-center h-full gap-[20px] px-[100px]">
