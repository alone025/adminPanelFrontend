const CardHomeBlog = () => {
  return (
    <div className="card-content relative max-w-[360px] justify-center xl:justify-normal xl:max-w-max max-h-[610px] ">
      <img className="img absolute top-0 left-0 h-full w-full bg-[#C4D3EA] rounded-[17px] -z-[1]"></img>
